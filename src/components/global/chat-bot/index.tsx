...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "Hello! I'm here to help you learn about WFII's virtual exhibition platform. Ask me anything!",
      isBot: true,
      timestamp: new Date(),
    },
  ])
  ...
  const findBestAnswer = (question: string): string => {
    ...
    return "I'd be happy to help! You can ask me about virtual exhibitions, platform features, pricing, technical requirements, or any other aspect of WFII's services. Try asking something like 'What is a virtual exhibition?' or 'How does pricing work?'"
  }
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 w-96 h-[500px] flex flex-col overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#FF4500] to-[#FF6347] text-white p-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-semibold">WFII Assistant</h3>
          ...
          <div className="p-4 border-t border-gray-200/50">
            <div className="flex space-x-2">
              <input
                ...
                placeholder="Ask me anything about WFII..."
