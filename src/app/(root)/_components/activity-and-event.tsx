...
export default function ActivityAndEvent() {
  ...
  return (
    <div
      id="event-activity"
      className="min-h-screen pt-6 bg-gradient-to-br from-[#F8F5EE] via-[#FCFCFA] to-[#F8F5EE]"
    >
      <div className="text-center mb-8 md:mb-16 backdrop-blur-sm mx-4 rounded-2xl p-8">
        ...
        <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed px-4">
          Explore our diverse range of carefully curated activities designed to
          foster innovation, facilitate networking, and drive business growth
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8 space-y-6 hidden lg:inline">
                <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-200/50">
                  <h2 className="text-2xl font-bold mb-4 text-transparent bg-gradient-to-r from-[#FF4500] via-[#FF6347] to-[#DC143C] bg-clip-text ">
                    Our Events & Activities
                  </h2>
                  <div className="space-y-3">
                    <div className="block text-gray-700 hover:text-[#FF4500] transition-colors duration-300 py-2 px-3 rounded-lg ">
                      Training Programs
                    </div>
                    <div className="block text-gray-700 hover:text-[#FF4500] transition-colors duration-300 py-2 px-3 rounded-lg ">
                      Exhibitions
